...
<?php
$updatedAt = $conn->query("SELECT updated_at FROM users WHERE id = $id")->fetch_assoc()['updated_at'];
echo "<p class='text-muted text-end'>Last updated on: " . date("F j, Y", strtotime($updatedAt)) . "</p>";
?>
    ...
    <form action="my_profile.php" method="post">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" name="username" maxlength="20" value="<?= htmlspecialchars($username); ?>" required>
          <div class="mt-2">
