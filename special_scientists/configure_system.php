...
// Helper to insert or update a config
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Handle “Remove current logo” checkbox
    if (isset($_POST['remove_logo']) && $_POST['remove_logo'] === '1') {
        $oldLogo = getConfig("logo_path", $conn);
        if ($oldLogo && file_exists(__DIR__ . "/" . $oldLogo)) {
            unlink(__DIR__ . "/" . $oldLogo);
        }
        saveConfig("logo_path", "", $conn);
        $logo_path  = "";
        $logo_saved = true;
    }
...
<body>
  ...
  <div class="container py-5">
    <h2 class="mb-4">
      <i class="bi bi-gear-fill me-2"></i>Configure System
    </h2>
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input
            ...
            name="moodle_url"
            class="form-control"
            value="<?= htmlspecialchars($moodle_url); ?>"
            required
          />
        </div>
